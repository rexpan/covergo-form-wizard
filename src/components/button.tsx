...
export function Button({buttonType, ...props}: ButtontProps) {
  return (
    <button className={["h-10 px-6 font-semibold rounded-md", buttonType ==  "primary" ? "bg-black text-white" : "border border-slate-200 text-slate-900"].join(" ")}
      {...props} />
  );
}
